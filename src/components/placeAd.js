...
class PlaceAd extends Component {
  ...
  render(){
    const { price, imgurl, onChangeImgUrl, linkurl, onChangeLinkUrl, onChangeTitle, title, submitText, submitHandler, id} = this.props
    return <div>
...
const mapStateToProps = ({imgurl, linkurl, title, id, currentValue}) => (
{
  imgurl,
  linkurl,
  title,
